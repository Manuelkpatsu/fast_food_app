...
class CustomColor {
  static const Color primaryColor = Color(0xfff54748);
  static const Color blackColor = Color(0xff1c1e23);
  static const Color hintColor = Color(0xff021638);
  static const Color navbarColor = Color(0xff081d43);
  static const Color yellowColor = Color(0xffff9f24);
  static const Color titleColor = Color(0xff323232);
  static const Color mediumDarkColor = Color(0xff646464);
  static const Color greyColor = Color(0xff92929d);
  ...
  static const Color starFilledColor = Color(0xfff6c949);
